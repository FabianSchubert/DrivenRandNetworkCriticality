...
def plot(ax):
    ...
    file = get_simfile_prop(os.path.join(DATA_DIR,'homogeneous_identical_binary_input_ESN/alt_hom_regulation/alt_hom_regulation'+mode))
...
if __name__ == '__main__':
    ...
    fig.savefig(os.path.join(PLOT_DIR,'homogeneous_identical_binary_input_alt_hom_regulation_r_a'+mode+'.pdf'))
    fig.savefig(os.path.join(PLOT_DIR,'homogeneous_identical_binary_input_alt_hom_regulation_r_a'+mode+'.png'),dpi=1000)
