...
if __name__ == '__main__':
    ...
    fig.savefig(os.path.join(PLOT_DIR,'heterogeneous_identical_binary_input_alt_hom_regulation_check_conv.pdf'))
    fig.savefig(os.path.join(PLOT_DIR,'heterogeneous_identical_binary_input_alt_hom_regulation_check_conv.png'),dpi=1000)
