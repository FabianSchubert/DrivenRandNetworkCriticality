...
if __name__ == '__main__':
    ...
    fig.savefig(os.path.join(PLOT_DIR,'homogeneous_identical_binary_input_corr_act_size_scaling_log.pdf'))
    fig.savefig(os.path.join(PLOT_DIR,'homogeneous_identical_binary_input_corr_act_size_scaling_log.png'),dpi=1000)
