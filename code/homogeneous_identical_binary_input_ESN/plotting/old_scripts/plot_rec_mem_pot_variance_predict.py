...
def plot(ax):
    ...
    simfile,timestamp = get_simfile_prop(os.path.join(DATA_DIR,'homogeneous_identical_binary_input_ESN/param_sweep_'))
...
if __name__ == '__main__':
    ...
    fig.savefig(os.path.join(PLOT_DIR,'homogeneous_identical_binary_input_rec_mem_pot_predict.pdf'))
    fig.savefig(os.path.join(PLOT_DIR,'homogeneous_identical_binary_input_rec_mem_pot_predict.png'),dpi=1000)
