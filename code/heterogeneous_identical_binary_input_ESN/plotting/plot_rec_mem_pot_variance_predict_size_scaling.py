...
if __name__ == '__main__':
    ...
    fig.savefig(os.path.join(PLOT_DIR,'heterogeneous_identical_binary_input_rec_mem_pot_predict_size_scaling.pdf'))
    fig.savefig(os.path.join(PLOT_DIR,'heterogeneous_identical_binary_input_rec_mem_pot_predict_size_scaling.png'),dpi=1000)
