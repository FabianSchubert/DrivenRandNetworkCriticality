...
def plot(ax):
    ...
    try:
        corr_df = pd.read_hdf(os.path.join(DATA_DIR,'homogeneous_identical_binary_input_ESN/corr_df.h5'), 'table')
    except:
        ...
        corr_df.to_hdf(os.path.join(DATA_DIR,'homogeneous_identical_binary_input_ESN/corr_df.h5'),'table')
...
if __name__ == '__main__':
    ...
    fig.savefig(os.path.join(PLOT_DIR,'homogeneous_identical_binary_input_corr_act.pdf'))
    fig.savefig(os.path.join(PLOT_DIR,'homogeneous_identical_binary_input_corr_act.png'),dpi=1000)
