...
print("plotting performance sigm_t sweep homogeneous_independent_gaussian...")
plot_performance_sweep.plot(ax1,'homogeneous_independent_gaussian')
print("plotting performance r_a sweep homogeneous_independent_gaussian...")
plot_alt_hom_regulation_performance_sweep.plot(ax2,'homogeneous_independent_gaussian','local')

print("plotting cross_corr sigm_t sweep homogeneous_independent_gaussian...")
plot_corr_act.plot(ax3,'homogeneous_independent_gaussian')
print("plotting cross_corr r_a sweep homogeneous_independent_gaussian...")
plot_alt_hom_regulation_corr_act.plot(ax4,'homogeneous_independent_gaussian','local')
...
fig.savefig(os.path.join(PLOT_DIR,'hom_gauss_input_composite.pdf'))
fig.savefig(os.path.join(PLOT_DIR,'hom_gauss_input_composite.png'),dpi=300)
