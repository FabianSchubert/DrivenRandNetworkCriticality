...
if __name__ == '__main__':
    ...
    fig.savefig(os.path.join(PLOT_DIR,'heterogeneous_independent_gaussian_input_alt_hom_regulation_r_a.pdf'))
    fig.savefig(os.path.join(PLOT_DIR,'heterogeneous_independent_gaussian_input_alt_hom_regulation_r_a.png'),dpi=1000)
