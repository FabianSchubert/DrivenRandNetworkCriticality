...
\end{center}
\caption{{\bf Spectral Radius Transition Approximation} White dashed lines denotes $\langle a_i\rangle_{\rm P}\!=\!1/\sigma_{\rm w}$. Yellow dashed line is given by \eqref{eq:gauss_approx_approx}, dotted line by \eqref{eq:crit_transition_gaussian_approx}.}
