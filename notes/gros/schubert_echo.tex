...
(orange line). Also shown is $\langle a_i\rangle_{\rm P}\!=\!1$ 
...
{\bf B:} ${a_i}$
from the simulation matches the numerically determined solution of \eqref{self_consistency_z}. Dashed lines are approximations given by \eqref{eq:gain_gaussian_approx}.
}
...
\end{center}
\caption{{\bf Critical Transition Approximation} White dashed lines denotes $\langle a_i\rangle_{\rm P}\!=\!1$. Yellow is given by \eqref{eq:circles_solution_form}, green line by \eqref{eq:crit_transition_gaussian_approx}.}
