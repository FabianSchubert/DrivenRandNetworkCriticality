...
def plot(ax):
    ...
    file_search_preprocess,timestamp_preprocess = get_simfile_prop(os.path.join(DATA_DIR,'heterogeneous_independent_gaussian_input_ESN/param_sweep_performance_processed_data_'),return_None=True)
    ...
    if file_search_preprocess != None:
        ...
        file_search = glob.glob(os.path.join(DATA_DIR,'heterogeneous_independent_gaussian_input_ESN/param_sweep_performance_*'))
        ...
        sweep_df.to_pickle(os.path.join(DATA_DIR,'heterogeneous_independent_gaussian_input_ESN/param_sweep_performance_processed_data_'+str(datetime.now().isoformat())+'.pkl'))
...
if __name__ == '__main__':
    ...
    fig.savefig(os.path.join(PLOT_DIR,'heterogeneous_independent_gaussian_input_xor_perf.pdf'))
    fig.savefig(os.path.join(PLOT_DIR,'heterogeneous_independent_gaussian_input_xor_perf.png'),dpi=1000)
