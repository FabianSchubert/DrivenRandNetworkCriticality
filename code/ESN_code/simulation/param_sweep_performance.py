...
if not(os.path.isdir(os.path.join(DATA_DIR, input_type+'_input_ESN/'))):
    os.makedirs(os.path.join(DATA_DIR, input_type+'_input_ESN/'))

np.savez(os.path.join(DATA_DIR, input_type+'_input_ESN/param_sweep_performance_'
